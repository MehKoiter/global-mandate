...
const S: Record<string, React.CSSProperties> = {
  ...
  title: { color: "#e8e8e8", fontSize: 16, letterSpacing: 2, textTransform: "uppercase" },
  divider: { color: "#333", fontSize: 18 },
  group: { display: "flex", gap: 16 },
  resource: { display: "flex", flexDirection: "column", alignItems: "center", minWidth: 70 },
  label: { color: "#666", fontSize: 11, textTransform: "uppercase", letterSpacing: 1 },
  value: { color: "#e8e8e8", fontSize: 14, fontWeight: "bold" },
  netValue: { fontSize: 11 },
  cp: { display: "flex", flexDirection: "column", alignItems: "center" },
  cpBar: { width: 100, height: 6, background: "#222", borderRadius: 3, marginTop: 4, overflow: "hidden" },
